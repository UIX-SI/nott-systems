...
LG/삼성/현대/롯데/한화      AI: llm/slm/stt/rag/ocr/dash  • 테마 적용된 React 프리뷰
SK / KT / 포스코            UI: auth/table/form/pay       • Starter ZIP (바로 실행되는 미니 프로젝트)
```
...
└── src\
    ...
    └── nott_06_06_v2.jsx           ← v6 (현재 활성, 카탈로그 확장 + 실행형 starter)
```
...
import App from "./nott_06_06_v2.jsx";       // v6 ← 현재
